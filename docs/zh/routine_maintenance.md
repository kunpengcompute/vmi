...
视频流云手机是一种基于Kbox容器和端云协同引擎的虚拟化方案。Kbox容器是指运行于ARM服务器上的Android系统Docker容器。端云协同引擎顾名思义可以分为端侧和云侧两个部分：云侧运行于云手机上；端侧一般为手机APK，可以被安装在用户的Android手机上，用于与云侧进行交互，进而对视频流云手机进行正常的操作。视频流云手机架构图如[\#ZH-CN\_TOPIC\_0000002549705369/fig13904113085011](#fig13904113085011)所示。
...
#### Docker服务状态<a name="ZH-CN_TOPIC_0000002549705375"></a>
...
### 主机CPU和内存使用率状态<a name="ZH-CN_TOPIC_0000002518345494"></a>
...
### 容器CPU和内存占用率状态<a name="ZH-CN_TOPIC_0000002518185588"></a>
...
#### Android侧查询日志操作<a name="ZH-CN_TOPIC_0000002549825389"></a>

##### ANR时应用堆栈信息<a name="ZH-CN_TOPIC_0000002549825383"></a>
...
#### Docker容器查询日志操作<a name="ZH-CN_TOPIC_0000002549705383"></a>
...
##### 容器内logcat日志信息<a name="ZH-CN_TOPIC_0000002518185602"></a>
...
##### 容器内top信息<a name="ZH-CN_TOPIC_0000002549825379"></a>
...
##### 容器dumpsys信息<a name="ZH-CN_TOPIC_0000002518185566"></a>
...
请参见《[视频流引擎 开发指南](https://www.hikunpeng.com/document/detail/zh/kunpengcps/cpturbokit/videostreamengine/kunpengcpsvideo_16_0001.html)》文档中用户对视频流对外接口、对外依赖接口等设置的参数进行记录，做到定期记录，可追溯。
