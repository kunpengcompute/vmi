...
## 1 运维概述<a name="ZH-CN_TOPIC_0000002549705369"></a>
...
## 2 巡检<a name="ZH-CN_TOPIC_0000002549825359"></a>

### 2.1 简介<a name="ZH-CN_TOPIC_0000002549705345"></a>

巡检是人工进行的例行检查。通过巡检操作，可以实时掌握视频流云手机的运行状况及周围环境的变化，发现其中的隐患，及时采取有效措施，提高对突发事件的处理效率，保证其安全和系统稳定。本文档主要以Docker容器运行时为例进行相关巡检项目的演示。

### 2.2 巡检项目和周期<a name="ZH-CN_TOPIC_0000002518345530"></a>
...
### 2.3 检查运行环境状态<a name="ZH-CN_TOPIC_0000002549705329"></a>

#### 2.3.1 Docker服务状态<a name="ZH-CN_TOPIC_0000002549705375"></a>
...
### 2.4 检查视频流云手机状态<a name="ZH-CN_TOPIC_0000002549825337"></a>

#### 2.4.1 容器状态<a name="ZH-CN_TOPIC_0000002518185572"></a>

##### 2.4.1.1 启动时容器状态<a name="ZH-CN_TOPIC_0000002518185580"></a>
...
#### 2.4.2 容器资源耗能<a name="ZH-CN_TOPIC_0000002549825327"></a>
...
#### 2.4.3 引擎服务状态<a name="ZH-CN_TOPIC_0000002518345526"></a>
...
3. 执行以下命令查看进程状态，分为以下两种情况：
    - 查看VmiAgent进程。若VmiAgent进程不存在，标明该进程已被终止，视频流云手机将不能正常使用，请联系华为技术支持。
...
## 3 监控<a name="ZH-CN_TOPIC_0000002549825319"></a>

### 3.1 简介<a name="ZH-CN_TOPIC_0000002549825345"></a>

监控是针对视频流云手机资源和应用的监控，通过应用监控您可以及时了解资源使用情况、趋势和告警，使用这些信息，您可以快速响应，保证云手机流畅运行。

### 3.2 主机CPU和内存使用率状态<a name="ZH-CN_TOPIC_0000002518345494"></a>
...
3. 执行以下命令，分别查询主机容器中进程的CPU及内存使用率等情况。如下图所示。
    ...
    >- USER：进程创建者。
    >- PR：进程优先级。
    >- NI：nice值。越小优先级越高，系统范围-20\~20，用户可设置范围-20\~19。
    ...
    若希望更直观的允许用户监视系统上运行的进程及其完整的命令，可以安装并使用htop工具，安装完成后执行以下命令即可。
...
### 3.3 容器CPU和内存占用率状态<a name="ZH-CN_TOPIC_0000002518185588"></a>
...
### 3.4 系统内存<a name="ZH-CN_TOPIC_0000002518345486"></a>
...
### 3.5 监控磁盘使用率状态<a name="ZH-CN_TOPIC_0000002518185538"></a>
...
## 4 日志管理<a name="ZH-CN_TOPIC_0000002549825375"></a>

### 4.1 简介<a name="ZH-CN_TOPIC_0000002549705353"></a>

日志管理提供强大的日志管理能力，包括日志检索、日志转储等功能。通过日志管理能够记录用户操作的审计日志，快速定位问题的根源、跟踪程序执行的过程，还能用于数据统计和性能分析等。

### 4.2 基础云手机维护工具<a name="ZH-CN_TOPIC_0000002518345458"></a>

Kbox云手机容器提供了Kbox\_maintainer（维护工具）。该工具包含日志收集、资源检查、故障恢复等功能，提升云手机原型的可测试性、可服务性、可维护性。该工具的获取和使用方法请参见《[Kbox云手机容器 例行维护](https://www.hikunpeng.com/document/detail/zh/kunpengcps/cpturbokit/kboxcpc/kunpengcpskbox_32_0028.html)》的“维护工具”章节。

### 4.3 视频流云手机查询日志操作<a name="ZH-CN_TOPIC_0000002518185612"></a>

#### 4.3.1 Android侧查询日志操作<a name="ZH-CN_TOPIC_0000002549825389"></a>
...
##### 4.3.2.1 系统日志信息<a name="ZH-CN_TOPIC_0000002549705337"></a>
...
##### 4.3.2.2 运行环境日志信息<a name="ZH-CN_TOPIC_0000002518185558"></a>
...
#### 4.3.3 Docker容器查询日志操作<a name="ZH-CN_TOPIC_0000002549705383"></a>

##### 4.3.3.1 容器元数据信息<a name="ZH-CN_TOPIC_0000002518185618"></a>
...
##### 4.3.3.2 容器内logcat日志信息<a name="ZH-CN_TOPIC_0000002518185602"></a>
...
##### 4.3.3.3 容器内进程信息<a name="ZH-CN_TOPIC_0000002518185548"></a>
...
##### 4.3.3.4 容器内top信息<a name="ZH-CN_TOPIC_0000002549825379"></a>
...
##### 4.3.3.5 容器属性信息<a name="ZH-CN_TOPIC_0000002549705359"></a>
...
##### 4.3.3.6 容器dumpsys信息<a name="ZH-CN_TOPIC_0000002518185566"></a>
...
### 4.4 视频流云手机导出日志操作<a name="ZH-CN_TOPIC_0000002518345508"></a>
...
### 4.6 日志审计<a name="ZH-CN_TOPIC_0000002518345444"></a>

请参见《[视频流引擎 开发指南](development_guide.md)》文档中用户对视频流对外接口、对外依赖接口等设置的参数进行记录，做到定期记录，可追溯。

## 5 高危操作<a name="ZH-CN_TOPIC_0000002549705379"></a>

### 5.1 禁用操作一览表<a name="ZH-CN_TOPIC_0000002518345522"></a>

禁用操作暂无，如有疑问，请联系华为技术支持。

### 5.2 高危操作一览表<a name="ZH-CN_TOPIC_0000002549825369"></a>
...
## 6 日常运维<a name="ZH-CN_TOPIC_0000002549705389"></a>

### 6.1 简介<a name="ZH-CN_TOPIC_0000002518185596"></a>
...
### 6.2 服务器状态<a name="ZH-CN_TOPIC_0000002518345468"></a>
...
### 6.3 容器状态<a name="ZH-CN_TOPIC_0000002518185608"></a>
...
3. 执行以下命令查询对应的容器编号，如下图所示展示的Docker容器运行状态。
    ...
    通过上图可以发现所有容器都为Up状态，若为其他状态，请视实际情况可将其删除，避免占用资源。

## 7 参考信息<a name="ZH-CN_TOPIC_0000002518345476"></a>
