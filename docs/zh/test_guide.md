# 测试指南<a name="ZH-CN_TOPIC_0000002521895632"></a>
...
服务器硬件以及软件包信息、用例验收前环境部署以及密度测试方法等信息请参见《[安装指南](install_guide.md)》，BIOS/iBMC/CPLD版本请参见《[版本配套表](release_notes.md#ZH-CN_TOPIC_0000002518346261)》。
