...
<!-- md-trans-meta sourceCommit=377087a2bd241cd72440e17b86df0cd93ee57185 translatedAt=2026-09-08T02:25:29.829Z pushedAt=2026-09-15T08:25:26.891Z -->
...
- Software and hardware constraints
  ...
  - The video stream engine server runs in the Kbox container, and the OS is Android 15.0.0_r17.
...
- Other constraints
  ...
  - When the adaptive vertical synchronization (vsync) function is enabled, the actual frame rate may be greater than the configured frame rate. You can configure a threshold through the `vmi.adaptive.vsync.threshold` parameter. It is recommended that the threshold be the same as the frame rate specification of the cloud phone. A smaller value reduces the probability of frame rate spikes, but may compromise the benefits of adaptive vsync.
