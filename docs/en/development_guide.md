...
|6|BoostKit-boostcph-videoengine_*_11.zip|Android 11 video stream engine development kit|Contact Huawei technical support.|
...
>- For details about the hardware requirements and deployment process of the server debugging environment, refer to [Video Stream Engine installation Guide](https://www.hikunpeng.com/document/detail/en/kunpengcps/boostcph/videostreamengine_ad15/docs/en/install_guide.md).
...
#### VmiErrCode (Error Code)<a name="ZH-CN_TOPIC_0000002549825783"></a>
...
For return value examples, see [Querying Component Version Information](user_guide.md#querying-component-version-information) in [Video Stream Engine User Guide](user_guide.md).
...
>![](public_sys-resources/icon-note.gif) **NOTE**
>
>`VmiConfig` needs to transfer the module version number mentioned in [VmiVersion (Module Version)](#module-version). The version number is specific to each module.
