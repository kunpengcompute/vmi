# Troubleshooting Cases<a name="ZH-CN_TOPIC_0000002552895603"></a>

## Troubleshooting Server Data Faults<a name="ZH-CN_TOPIC_0000002518346546"></a>

**Symptom<a name="section1331026193720"></a>**

When data on the engine server is damaged before or after encoding, the engine reports a data processing failure event (`VMI_VIDEO_ENGINE_ENCODE_ERR`) on the server. You can view related messages in logcat logs.
...
## Troubleshooting Data Callback Function Registration Faults on the Server<a name="ZH-CN_TOPIC_0000002549826375"></a>
...
## Troubleshooting Server Encoding Parameter Configuration<a name="ZH-CN_TOPIC_0000002549706369"></a>
