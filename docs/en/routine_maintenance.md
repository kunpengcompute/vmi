# Routine Maintenance<a name="ZH-CN_TOPIC_0000002521735640"></a>

## 1 O&M Overview<a name="ZH-CN_TOPIC_0000002549706251"></a>
...
## 2 Inspection<a name="ZH-CN_TOPIC_0000002549826261"></a>

### 2.1 Overview<a name="ZH-CN_TOPIC_0000002549826265"></a>
...
### 2.2 Inspection Items and Periods<a name="ZH-CN_TOPIC_0000002518186486"></a>
...
### 2.3 Checking the Operating Environment Status<a name="ZH-CN_TOPIC_0000002549706243"></a>

#### 2.3.1 Docker Service Status<a name="ZH-CN_TOPIC_0000002549826263"></a>
...
2. Query the Docker service status.
    ...
    ![](figures/zh-cn_image_0000002518346416.png)
...
### 2.4 Checking the Video Stream Cloud Phone Status<a name="ZH-CN_TOPIC_0000002518186490"></a>

#### 2.4.1 Container Status<a name="ZH-CN_TOPIC_0000002518346408"></a>

##### 2.4.1.1 Container Startup Status<a name="ZH-CN_TOPIC_0000002518346410"></a>
...
##### 2.4.1.2 Container Running Status<a name="ZH-CN_TOPIC_0000002549826257"></a>
...
#### 2.4.3 Engine Service Status<a name="ZH-CN_TOPIC_0000002518346400"></a>
...
3. Check the process status.
    - Check the `VmiAgent` process. If the process is not found, it indicates that `VmiAgent` is stopped and the video stream cloud phone cannot work normally. In this case, contact Huawei technical support.
        ...
        ![](figures/zh-cn_image_0000002518186500.png)

    - Check the `VmiAgent` process. If the process is found, check its process ID. In the example highlighted in the figure above, the process ID is `283`. Run the following command to check the process status, CPU usage, and memory usage. In the command, *${pid}* indicates the `VmiAgent` process ID. The command output is shown in the following figure.

        ```shell
        top -p ${pid}
        ```

        ![](figures/zh-cn_image_0000002549826271.png)

## 3 Monitoring<a name="ZH-CN_TOPIC_0000002549826259"></a>

### 3.1 Overview<a name="ZH-CN_TOPIC_0000002549706261"></a>
...
### 3.2 Host CPU and Memory Usage<a name="ZH-CN_TOPIC_0000002518186482"></a>
...
### 3.3 Container CPU and Memory Usage<a name="ZH-CN_TOPIC_0000002518346390"></a>
...
### 3.4 System Memory<a name="ZH-CN_TOPIC_0000002518186476"></a>
...
### 3.5 Drive Usage<a name="ZH-CN_TOPIC_0000002518186472"></a>
...
3. Check the drive usage of the video stream cloud phone server.
    ...
    ![](figures/zh-cn_image_0000002549706265.png)
...
### 3.6 System Load<a name="ZH-CN_TOPIC_0000002518186478"></a>
...
### 4.1 Overview<a name="ZH-CN_TOPIC_0000002518186492"></a>
...
#### 4.3.1 Querying Logs on the Android Device<a name="ZH-CN_TOPIC_0000002549826251"></a>

##### 4.3.1.1 Application Stack Information During ANR<a name="ZH-CN_TOPIC_0000002518346392"></a>
...
#### 4.3.2 Querying Logs on the Server<a name="ZH-CN_TOPIC_0000002549706245"></a>

##### 4.3.2.1 System Log Information<a name="ZH-CN_TOPIC_0000002549826249"></a>
...
##### 4.3.2.2 Operating Environment Log Information<a name="ZH-CN_TOPIC_0000002549706241"></a>
...
#### 4.3.3 Querying Docker Container Logs<a name="ZH-CN_TOPIC_0000002549826247"></a>

##### 4.3.3.1 Metadata Information<a name="ZH-CN_TOPIC_0000002518346394"></a>
...
##### 4.3.3.2 logcat Log Information<a name="ZH-CN_TOPIC_0000002549706257"></a>
...
##### 4.3.3.3 Process Information<a name="ZH-CN_TOPIC_0000002518346398"></a>
...
##### 4.3.3.4 Top Information<a name="ZH-CN_TOPIC_0000002549706247"></a>
...
##### 4.3.3.5 Container Property Information<a name="ZH-CN_TOPIC_0000002549706249"></a>
...
##### 4.3.3.6 dumpsys Information<a name="ZH-CN_TOPIC_0000002518186494"></a>
...
4. Run the following command to obtain the diagnosis output of all system services in the container. In the command, *${android_id}* indicates the ID of the started instance.
    ...
    - To obtain the container memory information, run the following command:
        ...
        ![](figures/zh-cn_image_0000002549706271.png)

### 4.4 Exporting Video Stream Cloud Phone Logs<a name="ZH-CN_TOPIC_0000002549826245"></a>
...
### 4.5 Log Overflow Dump<a name="ZH-CN_TOPIC_0000002549706253"></a>
...
### 4.6 Log Audit<a name="ZH-CN_TOPIC_0000002549706259"></a>
...
## 5 Risky Operations<a name="ZH-CN_TOPIC_0000002518186480"></a>
...
## 6 Routine O&M<a name="ZH-CN_TOPIC_0000002518186474"></a>

### 6.1 Overview<a name="ZH-CN_TOPIC_0000002549706255"></a>
...
### 6.2 Server Status<a name="ZH-CN_TOPIC_0000002518346406"></a>
...
### 6.3 Container Status<a name="ZH-CN_TOPIC_0000002549826253"></a>
...
3. Run the following command to list containers. The following figure shows the running status of Docker containers.
    ...
    ![](figures/zh-cn_image_0000002518346412.png)

    The preceding figure shows a container in the Up state. If there are containers in other states, delete them as required to release resources.

## 7 References<a name="ZH-CN_TOPIC_0000002549826243"></a>
