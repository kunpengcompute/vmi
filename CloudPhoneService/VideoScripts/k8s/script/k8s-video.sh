...
MAX=$3
ENABLE_F2FS=$4
SYSTEM_SIZE_MB=$5  # 新增：第五个参数，限定system分区大小(MB)
...
function start(){
    ...
    do
        ...
        touch /var/run/containerd/video$j  # 用于存放容器ID
        export HOSTPORT=$(expr $j + 8000)   # 宿主机端口号
        ...
        # =========================================================================
        # 新增逻辑：提取 Container ID，检查文件系统并挂载 XFS Quota
        # =========================================================================
