 ...
 * 功能说明: 适配T432 ffmpeg硬件视频编码器，包括编码器初始化、启动、编码、停止、销毁等
 */
#ifndef VIDEO_ENCODER_T432_H
#define VIDEO_ENCODER_T432_H
...
enum T432CodecType : uint32_t {
    T432_CODEC_TYPE_H264 = 0,
    T432_CODEC_TYPE_H265 = 1
};

class VideoEncoderT432 : public VideoEncoderCommon {
public:
    /**
     * @功能描述: 构造函数
     */
    explicit VideoEncoderT432(T432CodecType codecType, EncoderFormat codecFormat);

    /**
     * @功能描述: 析构函数
     */
    ~VideoEncoderT432() override;
...
private:
     ...
     *          false 失败
     */
    bool LoadT432SharedLib();

    /**
     * @功能描述: 卸载T432动态库
     */
    void UnLoadT432SharedLib();
    ...
    std::string m_codec = "h264_ni_logan_enc";
