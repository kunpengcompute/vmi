...
JNIEXPORT jboolean JNICALL OPENGL_JNI(startVideo)(JNIEnv *env, jclass cls, jobject obj) {
    ...
    jclass vmiConfigVideoClass = env->FindClass("com/huawei/cloudphonesdk/maincontrol/config/VmiConfigVideo");
    jfieldID jencoderType = env->GetFieldID(vmiConfigVideoClass, "encoderType", "I");
    jfieldID jvideoFrameType = env->GetFieldID(vmiConfigVideoClass, "videoFrameType", "I");
    jfieldID jwidth = env->GetFieldID(vmiConfigVideoClass, "width", "I");
    jfieldID jheight = env->GetFieldID(vmiConfigVideoClass, "height", "I");
    jfieldID jwidthAligned = env->GetFieldID(vmiConfigVideoClass, "widthAligned", "I");
    jfieldID jheightAligned = env->GetFieldID(vmiConfigVideoClass, "heightAligned", "I");
    jfieldID jdensity = env->GetFieldID(vmiConfigVideoClass, "density", "I");
    jfieldID jrenderOptimize = env->GetFieldID(vmiConfigVideoClass, "renderOptimize", "Z");
    jfieldID jencodeParams= env->GetFieldID(vmiConfigVideoClass, "encodeParams", "Lcom/huawei/cloudphonesdk/maincontrol/config/EncodeParams;");
    jclass encodeParamsClass= env->FindClass("com/huawei/cloudphonesdk/maincontrol/config/EncodeParams");
    jfieldID jbitrate = env->GetFieldID(encodeParamsClass, "bitrate", "I");
    jfieldID jgopSize = env->GetFieldID(encodeParamsClass, "gopSize", "I");
    jfieldID jprofile = env->GetFieldID(encodeParamsClass, "profile", "I");
    jfieldID jrcMode = env->GetFieldID(encodeParamsClass, "rcMode", "I");
    jfieldID jforceKeyFrame = env->GetFieldID(encodeParamsClass, "forceKeyFrame", "I");
    jfieldID jinterpolation = env->GetFieldID(encodeParamsClass, "interpolation", "Z");
    jfieldID jcrf = env->GetFieldID(encodeParamsClass, "crf", "I");
    jfieldID jmaxCrfRate = env->GetFieldID(encodeParamsClass, "maxCrfRate", "I");
    jfieldID jvbvBufferSize = env->GetFieldID(encodeParamsClass, "vbvBufferSize", "I");
    jfieldID jstreamWidth = env->GetFieldID(encodeParamsClass, "streamWidth", "I");
    jfieldID jstreamHeight = env->GetFieldID(encodeParamsClass, "streamHeight", "I");
    ...
    jobject encodeParamsObj = env->GetObjectField(obj,jencodeParams);
    jint bitrate = env->GetIntField(encodeParamsObj, jbitrate);
    jint gopSize = env->GetIntField(encodeParamsObj, jgopSize);
    jint profile = env->GetIntField(encodeParamsObj, jprofile);
    jint rcMode = env->GetIntField(encodeParamsObj, jrcMode);
    jint forceKeyFrame = env->GetIntField(encodeParamsObj, jforceKeyFrame);
    jboolean interpolation = env->GetBooleanField(encodeParamsObj, jinterpolation);
    jint crf = env->GetIntField(encodeParamsObj, jcrf);
    jint maxCrfRate = env->GetIntField(encodeParamsObj, jmaxCrfRate);
    jint vbvBufferSize = env->GetIntField(encodeParamsObj, jvbvBufferSize);
    jint streamWidth = env->GetIntField(encodeParamsObj, jstreamWidth);
    jint streamHeight = env->GetIntField(encodeParamsObj, jstreamHeight);
...
JNIEXPORT jboolean JNICALL OPENGL_JNI(setAudioParam)(JNIEnv *env, jclass cls, jobject obj) {
    ...
    jclass paramsClass = env->FindClass("com/huawei/cloudphonesdk/maincontrol/config/AudioPlayParams");

    jfieldID jaudioType = env->GetFieldID(objClass, "audioType", "I");
    jfieldID jparams = env->GetFieldID(objClass, "audioPlayParams", "Lcom/huawei/cloudphonesdk/maincontrol/config/AudioPlayParams;");
    jfieldID jsampleInterval = env->GetFieldID(paramsClass, "sampleInterval", "I");
    jfieldID jbitrate = env->GetFieldID(paramsClass, "bitrate", "I");

    jint audioType = env->GetIntField(obj, jaudioType);
    jobject paramsObj = env->GetObjectField(obj, jparams);
    jint sampleInterval = env->GetIntField(paramsObj, jsampleInterval);
    jint bitrate = env->GetIntField(paramsObj, jbitrate);
